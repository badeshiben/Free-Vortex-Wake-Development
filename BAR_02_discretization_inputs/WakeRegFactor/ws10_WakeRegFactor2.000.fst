...
---------------------- INPUT FILES ---------------------------------------------
"OpenFAST_BAR_02_ElastoDyn_ws10_WakeRegFactor2.000.dat" EDFile        - Name of file containing ElastoDyn input parameters (quoted string)
...
"OpenFAST_BAR_02_InflowFile_ws10_WakeRegFactor2.000.dat" InflowFile    - Name of file containing inflow wind input parameters (quoted string)
"OpenFAST_BAR_02_AeroDyn15_ws10_WakeRegFactor2.000.dat" AeroFile      - Name of file containing aerodynamic input parameters (quoted string)
