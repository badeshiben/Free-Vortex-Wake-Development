...
0.152         DT            - Recommended module time step (s)
...
---------------------- INPUT FILES ---------------------------------------------
"OpenFAST_BAR_02_ElastoDyn_ws4_CoreSpreadEddyVisc1000.000.dat" EDFile        - Name of file containing ElastoDyn input parameters (quoted string)
...
"OpenFAST_BAR_02_InflowFile_ws4_CoreSpreadEddyVisc1000.000.dat" InflowFile    - Name of file containing inflow wind input parameters (quoted string)
"OpenFAST_BAR_02_AeroDyn15_ws4_CoreSpreadEddyVisc1000.000.dat" AeroFile      - Name of file containing aerodynamic input parameters (quoted string)
...
0.152         DT_Out        - Time step for tabular output (s) (or "default")
