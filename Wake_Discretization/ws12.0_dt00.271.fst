...
---------------------- INPUT FILES ---------------------------------------------
"OpenFAST_BAR_00_ElastoDyn_ws12.0_dt00.271.dat" EDFile        - Name of file containing ElastoDyn input parameters (quoted string)
...
"OpenFAST_BAR_00_InflowFile_ws12.0_dt00.271.dat" InflowFile    - Name of file containing inflow wind input parameters (quoted string)
"OpenFAST_BAR_00_AeroDyn15_ws12.0_dt00.271.dat" AeroFile      - Name of file containing aerodynamic input parameters (quoted string)
"OpenFAST_BAR_00_ServoDyn_ws12.0_dt00.271.dat" ServoFile     - Name of file containing control and electrical-drive input parameters (quoted string)
